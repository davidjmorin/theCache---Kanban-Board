class KanbanApp {
    ...
    async loadBoardData() {
        try {
            ...
            if (!this.data.currentBoard) {
                const [companyData, boardsData] = await Promise.all([
    ...
    showDescriptionEditorModal(taskId, currentDescription = '') {
        ...
        if (this.descriptionPopupEditor) {
            this.descriptionPopupEditor.value(currentDescription);
        } else {
            document.getElementById('descriptionEditorText').value = currentDescription;
        }
